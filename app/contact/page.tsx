...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Keith O'Brien for B2B content and ghostwriting projects",
};
...
export default function ContactPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
      <h1 className="text-3xl font-semibold text-gray-900 mb-4">Let&apos;s work together</h1>
          ...
          <div className="sticky top-8 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="https://www.linkedin.com/in/keithobrien/"
                  target="_blank"
                ...
                <a
                  href="https://github.com/k-obrien17"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-600 hover:text-orange-500 transition-colors"
                >
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">
                <span className="font-medium text-gray-900">Typical response:</span> Within 24 hours on business days
              </p>
            </div>
          </div>
        </div>
